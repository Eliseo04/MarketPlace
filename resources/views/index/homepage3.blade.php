...
<!-- Mirrored from madebydesignesia.com/themes/gigaland/03_grey-index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 14:14:58 GMT -->
<head>
    <title>Gigaland - NFT Marketplace Website Template</title>
    <link rel="icon" href="{{asset('gigaland')}}/images/icon.png" type="image/gif" sizes="16x16">
    ...
    <!-- color scheme -->   
    <link id="colors" href="{{asset('gigaland')}}/css/colors/scheme-01.css" rel="stylesheet" type="text/css" />
...
<body class="dark-scheme de-grey">
                                ...
                                <div class="de-flex-col">
                                    ...
                                    <div id="logo">
                                        <a href="{{asset('gigaland')}}/03_grey-index.html">
                                            <img alt="" src="{{asset('gigaland')}}/images/logo-light.png" />
                                        </a>
                                    </div>
                                    <!-- logo close -->
                                </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <div class="spacer-10"></div>
                                <a href="{{asset('gigaland')}}/03_grey-explore.html" class="btn-main wow fadeInUp lead" data-wow-delay="1.25s">Explore</a>                                
                                <div class="row">
                                    <div class="spacer-single"></div>
                                    <div class="row">
                            ...
                            <div class="col-md-6 xs-hide">
                                <img src="{{asset('gigaland')}}/images/misc/women-with-vr.png" class="img-fluid wow fadeInUp" data-wow-delay=".75s" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-sm-4 col-6 mb30">
                            <a class="box-url style-2" href="{{asset('gigaland')}}/login.html">
                                <img src="{{asset('gigaland')}}/images/wallet/1.png" alt="" class="mb20">
                                <h4>Metamask</h4>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-2 col-sm-4 col-6 mb30">
                            <a class="box-url style-2" href="{{asset('gigaland')}}/login.html">
                                <img src="{{asset('gigaland')}}/images/wallet/2.png" alt="" class="mb20">
                                <h4>Bitski</h4>
                            </a>
                        </div>       
                        ...
                        <div class="col-lg-2 col-sm-4 col-6 mb30">
                            <a class="box-url style-2" href="{{asset('gigaland')}}/login.html">
                                <img src="{{asset('gigaland')}}/images/wallet/3.png" alt="" class="mb20">
                                <h4>Fortmatic</h4>
                            </a>
                        </div>    
                        ...
                        <div class="col-lg-2 col-sm-4 col-6 mb30">
                            <a class="box-url style-2" href="{{asset('gigaland')}}/login.html">
                                <img src="{{asset('gigaland')}}/images/wallet/4.png" alt="" class="mb20">
                                <h4>WalletConnect</h4>
                            </a>
                        </div>
                        ...
                        <div class="col-lg-2 col-sm-4 col-6 mb30">
                            <a class="box-url style-2" href="{{asset('gigaland')}}/login.html">
                                <img src="{{asset('gigaland')}}/images/wallet/5.png" alt="" class="mb20">
                        ...
                        <div class="col-lg-2 col-sm-4 col-6 mb30">
                            <a class="box-url style-2" href="{{asset('gigaland')}}/login.html">
                                <img src="{{asset('gigaland')}}/images/wallet/6.png" alt="" class="mb20">
                                <h4>Arkane</h4>
                            </a>
                        </div>
                ...
                <div class="container">
                            ...
                            <div class="row wow fadeIn"> 
                                ...
                                <div id="items-carousel" class="owl-carousel wow fadeIn">
                                        ...
                                        <div class="nft__item style-2">
                                            ...
                                            <div class="nft__item_wrap">
                                                ...
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                                    ...
                                                    <img src="{{asset('gigaland')}}/images/items-alt/static-1.jpg" class="lazy nft__item_preview" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <div class="d-item">
                                        <div class="nft__item style-2">
                                            ...
                                            <div class="nft__item_wrap">
                                                ...
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                                    <div class="d-placeholder"></div>
                                                    <img src="{{asset('gigaland')}}/images/items-alt/static-2.jpg" class="lazy nft__item_preview" alt="">
                                                </a>
                                            </div>
                                            <div class="nft__item_info">
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                    ...
                                    <div class="d-item">
                                        <div class="nft__item style-2">
                                            <div class="de_countdown id-color" data-year="2025" data-month="5" data-day="12" data-hour="8"></div>
                                            <div class="author_list_pp">
                                            ...
                                            <div class="nft__item_wrap">
                                                ...
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                                    <div class="d-placeholder"></div>
                                                    <img src="{{asset('gigaland')}}/images/items-alt/static-3.jpg" class="lazy nft__item_preview" alt="">
                                                </a>
                                            </div>
                                            <div class="nft__item_info">
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                    ...
                                    <div class="d-item">
                                        <div class="nft__item style-2">
                                            ...
                                            <div class="nft__item_wrap">
                                                ...
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                                    <div class="d-placeholder"></div>
                                                    <img src="{{asset('gigaland')}}/images/items-alt/static-4.jpg" class="lazy nft__item_preview" alt="">
                                                </a>
                                            </div>
                                            <div class="nft__item_info">
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                    ...
                                    <div class="d-item">
                                        <div class="nft__item style-2">
                                            <div class="de_countdown id-color" data-year="2025" data-month="5" data-day="15" data-hour="10"></div>
                                            <div class="author_list_pp">
                                            ...
                                            <div class="nft__item_wrap">
                                                ...
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                                    <div class="d-placeholder"></div>
                                                    <img src="{{asset('gigaland')}}/images/items-alt/static-5.jpg" class="lazy nft__item_preview" alt="">
                                                </a>
                                            </div>
                                            <div class="nft__item_info">
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                    ...
                                    <div class="d-item">
                                        <div class="nft__item style-2">
                                            ...
                                            <div class="nft__item_wrap">
                                                ...
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                                    <div class="d-placeholder"></div>
                                                    <img src="{{asset('gigaland')}}/images/items-alt/static-6.jpg" class="lazy nft__item_preview" alt="">
                                                </a>
                                            </div>
                                            <div class="nft__item_info">
                                                <a href="{{asset('gigaland')}}/03_grey-item-details.html">
                                    ...
                                    <div class="d-item">
                                        <div class="nft__item style-2">
                                            <div class="de_countdown id-color" data-year="2025" data-month="5" data-day="8" data-hour="8"></div>
                                            <div class="author_list_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-author.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Creator: Gigaland">                                    
                            ...
                            <div class="row">
                                ...
                                <div id="collection-carousel-alt" class="owl-carousel wow fadeIn">
                                        ...
                                        <div class="nft_coll style-2">
                                            <div class="nft_wrap">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img src="{{asset('gigaland')}}/images/collections/coll-1.jpg" class="lazy img-fluid" alt=""></a>
                                            </div>
                                            <div class="nft_coll_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img class="lazy pp-coll" src="{{asset('gigaland')}}/images/author/author-1.jpg" alt=""></a>
                                                <i class="fa fa-check"></i>
                                            </div>
                                            <div class="nft_coll_info">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><h4>Abstraction</h4></a>
                                                <span>ERC-192</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nft_coll style-2">
                                            <div class="nft_wrap">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img src="{{asset('gigaland')}}/images/collections/coll-2.jpg" class="lazy img-fluid" alt=""></a>
                                            </div>
                                            <div class="nft_coll_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img class="lazy pp-coll" src="{{asset('gigaland')}}/images/author/author-2.jpg" alt=""></a>
                                                <i class="fa fa-check"></i>
                                            </div>
                                            <div class="nft_coll_info">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><h4>Patternlicious</h4></a>
                                                <span>ERC-61</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nft_coll style-2">
                                            <div class="nft_wrap">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img src="{{asset('gigaland')}}/images/collections/coll-3.jpg" class="lazy img-fluid" alt=""></a>
                                            </div>
                                            <div class="nft_coll_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img class="lazy pp-coll" src="{{asset('gigaland')}}/images/author/author-3.jpg" alt=""></a>
                                                <i class="fa fa-check"></i>
                                            </div>
                                            <div class="nft_coll_info">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><h4>Skecthify</h4></a>
                                                <span>ERC-126</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nft_coll style-2">
                                            <div class="nft_wrap">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img src="{{asset('gigaland')}}/images/collections/coll-4.jpg" class="lazy img-fluid" alt=""></a>
                                            </div>
                                            <div class="nft_coll_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img class="lazy pp-coll" src="{{asset('gigaland')}}/images/author/author-4.jpg" alt=""></a>
                                                <i class="fa fa-check"></i>
                                            </div>
                                            <div class="nft_coll_info">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><h4>Cartoonism</h4></a>
                                                <span>ERC-73</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nft_coll style-2">
                                            <div class="nft_wrap">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img src="{{asset('gigaland')}}/images/collections/coll-5.jpg" class="lazy img-fluid" alt=""></a>
                                            </div>
                                            <div class="nft_coll_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img class="lazy pp-coll" src="{{asset('gigaland')}}/images/author/author-5.jpg" alt=""></a>
                                                <i class="fa fa-check"></i>
                                            </div>
                                            <div class="nft_coll_info">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><h4>Virtuland</h4></a>
                                                <span>ERC-85</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nft_coll style-2">
                                            <div class="nft_wrap">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img src="{{asset('gigaland')}}/images/collections/coll-6.jpg" class="lazy img-fluid" alt=""></a>
                                            </div>
                                            <div class="nft_coll_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><img class="lazy pp-coll" src="{{asset('gigaland')}}/images/author/author-6.jpg" alt=""></a>
                                                <i class="fa fa-check"></i>
                                            </div>
                                            <div class="nft_coll_info">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html"><h4>Papercut</h4></a>
                                                <span>ERC-42</span>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 wow fadeIn">
                                        <ol class="author_list">
                                            <li>                                    
                                                <div class="author_list_pp">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">
                                                        <img class="lazy" src="{{asset('gigaland')}}/images/author/author-1.jpg" alt="">
                                                        <i class="fa fa-check"></i>
                                                    </a>
                                                </div>                                    
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Monica Lucas</a>
                                                    <span>3.2 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Mamie Barnett</a>
                                                    <span>2.8 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Nicholas Daniels</a>
                                                    <span>2.5 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Lori Hart</a>
                                                    <span>2.2 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Jimmy Wright</a>
                                                    <span>1.9 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Karla Sharp</a>
                                                    <span>1.6 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Gayle Hicks</a>
                                                    <span>1.5 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Claude Banks</a>
                                                    <span>1.3 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Franklin Greer</a>
                                                    <span>0.9 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Stacy Long</a>
                                                    <span>0.8 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Ida Chapman</a>
                                                    <span>0.6 ETH</span>
                                                </div>
                                            </li>
                                            <li>
                                                ...
                                                <div class="author_list_info">
                                                    <a href="{{asset('gigaland')}}/03_grey-author.html">Fred Ryan</a>
                                                    <span>0.5 eth</span>
                                                </div>
                                            </li>
                                        </ol>
    ...
    <script src="{{asset('gigaland')}}/js/particles.js"></script>
    <script src="{{asset('gigaland')}}/js/particles-settings.js"></script>

</body>


<!-- Mirrored from madebydesignesia.com/themes/gigaland/03_grey-index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 14:15:02 GMT -->
</html>