...
<!-- Mirrored from madebydesignesia.com/themes/gigaland/03_grey-item-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 14:15:11 GMT -->
<head>
...
<body class="dark-scheme de-grey">
    <div id="wrapper">
            ...
            <!-- header begin -->
            <header class="transparent border-bottom">
                <div class="container">
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="row g-5">
                        <div class="col-md-6 text-center">
                            <div class="nft-image-wrapper">
                                <img src="{{asset('gigaland')}}/images/items/big-4.jpg" class="image-autosize img-fluid img-rounded mb-sm-30" alt="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="item_info">
                                ...
                                <div class="d-flex flex-row">
                                    ...
                                    <div>
                                        ...
                                        <div class="item_author">                                    
                                            <div class="author_list_pp">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html">
                                                    <img class="lazy" src="{{asset('gigaland')}}/images/collections/coll-thumbnail-1.jpg" alt="">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                            </div>                                    
                                            <div class="author_list_info">
                                                <a href="{{asset('gigaland')}}/03_grey-collection.html">AnimeSailorClub</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-1">
                                        ...
                                        <div class="row gx-2">
                                            <div class="col-lg-4 col-md-6 col-sm-6">
                                                <a href="{{asset('gigaland')}}/#" class="nft_attr">
                                                    <h5>Background</h5>
                                                    <h4>Yellowish Sky</h4>
                                ...
                                <h6>Price</h6>
                                <div class="nft-item-price"><img src="{{asset('gigaland')}}/images/misc/ethereum.svg" alt=""><span>0.059</span>($253.67)</div>

                                <!-- Button trigger modal -->
                                <a href="{{asset('gigaland')}}/#" class="btn-main btn-lg" data-bs-toggle="modal" data-bs-target="#buy_now">
                                  Buy Now
                                </a>
                                &nbsp;
                                <a href="{{asset('gigaland')}}/#" class="btn-main btn-lg btn-light" data-bs-toggle="modal" data-bs-target="#place_a_bid">
                                  Place a Bid
                                </a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="p-3 form-border">
                    ...
                    <div class="spacer-single"></div>
                    <a href="{{asset('gigaland')}}/03_grey-wallet.html" target="_blank" class="btn-main btn-fullwidth">Add funds</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="p-3 form-border">
                    ...
                    <div class="spacer-single"></div>
                    <a href="{{asset('gigaland')}}/03_grey-wallet.html" target="_blank" class="btn-main btn-fullwidth">Place a bid</a>
                </div>
              </div>
            </div>
          </div>
...
<!-- Mirrored from madebydesignesia.com/themes/gigaland/03_grey-item-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Apr 2025 14:15:12 GMT -->
</html>